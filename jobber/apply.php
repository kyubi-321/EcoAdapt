            ...
            if (move_uploaded_file($resumeTmp, $resumePath)) {
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    try {
                        ...
                        $mail->SMTPAuth = true;
                        $mail->Username = 'ankitbadhani102@gmail.com'; // Replace with your email
                        $mail->Password = 'khly nmjr chza fapc'; // Replace with your email password
                        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                        $mail->Port = 587;

                        // Applicant email
                        $mail->setFrom('ankitbadhani102@gmail.com', 'EcoAdopt Job Portal');
                        ...
                        // Admin email
                        $mail->clearAddresses();
                        $mail->addAddress('ankitbadhani102@gmail.com'); // Replace with admin email
